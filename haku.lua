...
-- daftar checkpoint
local checkpoints = {
    [1] = Vector3.new(-956.5, 166.2, -366.6),
    [2] = Vector3.new(-205.2, 623.5, -563.5),
    [3] = Vector3.new(2602.3, 948.4, -123.125),
    [4] = Vector3.new(4334.8, 1232.6, 531.7),
    [5] = Vector3.new(4760.6, 1280.4, -270.5),
    [6] = Vector3.new(5661.3, 1975.9, 440.5),
}
