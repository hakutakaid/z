...
local function createGUI()
    ...
    -- Checkpoints
    local checkpoints = {
        {name = "Checkpoint 1", pos = Vector3.new(135.7, 141.5, -174.7)},
        {name = "Checkpoint 2", pos = Vector3.new(326.4, 89.5, -434.0)},
        {name = "Checkpoint 3", pos = Vector3.new(476.1, 169.6, -940.2)},
        {name = "Checkpoint 4", pos = Vector3.new(930.1, 133.1, -626.0)},
        {name = "Checkpoint 5", pos = Vector3.new(923.4, 101.4, 279.6)},
        {name = "Checkpoint 6", pos = Vector3.new(304.0, 303.8, 685.5)},
    }
    ...
    RestartBtn.MouseButton1Click:Connect(function()
        ScreenGui:Destroy()
        loadstring(game:HttpGet("https://raw.githubusercontent.com/hakutakaid/z/refs/heads/master/arunika.lua"))()
    end)
    -- Respawn Button
