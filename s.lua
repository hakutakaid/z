...
-- daftar checkpoint
local checkpoints = {
    [1] = Vector3.new(-621.7, 251.7, -383.9),
    [2] = Vector3.new(-1203.2, 263.1, -487.1),
    [3] = Vector3.new(-1399.3, 579.8, -949.9),
    [4] = Vector3.new(-1701.0, 818.0, -1400.0),
    [5] = Vector3.new(-2815.3, 1631.9, -2436.9),
    [6] = Vector3.new(-3102.4, 1694.7, -2561.0),
}
