...
local function createGUI()
    ...
    -- Checkpoints
    local checkpoints = {
        {name = "Checkpoint 1", pos = Vector3.new(-3192.0, 1788.4, -2574.7)},
    ...
    RestartBtn.MouseButton1Click:Connect(function()
        ScreenGui:Destroy()
        loadstring(game:HttpGet("https://raw.githubusercontent.com/hakutakaid/z/refs/heads/master/antartika.lua"))()
    end)
    -- Respawn Button
